    ...
    IReadOnlyList<ICompressionStrategy> compressionStrategies)
{
        ...
        string destinationPath)
    {
        ...
        IEncryptionAlgorithmStrategy? selectedEncryption = this.ResolveEncryptionStrategy(settings);

        string password = string.Empty;
        string confirmPassword = string.Empty;
        IKeyDerivationAlgorithmStrategy? selectedKdf = this.ResolveKeyDerivationStrategy(settings);
        ...
        ICompressionStrategy? selectedCompression = this.ResolveCompressionStrategy(settings);
        INameObfuscationStrategy? selectedObfuscation = this.ResolveNameObfuscationStrategy(settings);
