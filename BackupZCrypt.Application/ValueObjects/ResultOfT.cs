...
public class Result<T> : Result
{
    ...
    protected Result([AllowNull] T value, bool isSuccess, IReadOnlyList<LocalizableMessage> errors)
    ...
    public static implicit operator Result<T>(MessageCode code)
    {
        return Failure(code);
    }
    ...
    {
        return new(default, false, [new LocalizableMessage(code, args)]);
    }
