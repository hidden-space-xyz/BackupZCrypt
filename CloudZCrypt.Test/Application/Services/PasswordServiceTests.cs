...
internal sealed class PasswordServiceTests
{
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength(null!);
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength("abc");
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength("abcdefghij");
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength("aaaaaaaaaa");
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength("password123");
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength("abcdefgh");
    ...
    {
        PasswordStrengthAnalysis lowResult = _service.AnalyzePasswordStrength("abcdefghij");
        PasswordStrengthAnalysis highResult = _service.AnalyzePasswordStrength("aBc1dE!gHi");
    ...
    {
        PasswordStrengthAnalysis result = _service.AnalyzePasswordStrength("anyPassword!123");
