...
public sealed class UpdateBackupCommandHandlerTests
{
    ...
    [Fact]
    internal async Task HandleAsync_Command_MapsOntoAnUpdateRequestAndForwardsTheProgress()
    {
        this.PassValidation();
