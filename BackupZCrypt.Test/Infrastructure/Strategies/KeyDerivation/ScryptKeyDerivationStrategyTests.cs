...
{
    private ScryptKeyDerivationStrategy strategy = null!;

    [SetUp]
    public void SetUp()
    {
        this.strategy = new ScryptKeyDerivationStrategy();
    }

    [Test]
    public void Id_ReturnsScrypt()
    {
        Assert.That(this.strategy.Id, Is.EqualTo(KeyDerivationAlgorithm.Scrypt));
    }

    [Test]
    public void DisplayName_ContainsScrypt()
    {
        Assert.That(this.strategy.DisplayName, Does.Contain("Scrypt"));
    }
