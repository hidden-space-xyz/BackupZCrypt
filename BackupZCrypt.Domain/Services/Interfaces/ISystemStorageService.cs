...
public interface ISystemStorageService
{
    ...
    /// <returns>The root of <paramref name="fullPath"/>, or <see langword="null"/> if it cannot be determined.</returns>
    ...
    /// <returns>The available free space in bytes, or <c>-1</c> if the drive is not ready or cannot be queried.</returns>
